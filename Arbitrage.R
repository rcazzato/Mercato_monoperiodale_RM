################################################################################
  ...
  Title: "Appunti di Gestione del Rischio - Mercato Monoperiodale (Arbitraggio)"
  Date: 27/04/2021
################################################################################
#l'obiettivo è trovare delle opportunità di arbitraggio in un mercato monoperiodale
#input (esempio)
